...
namespace Raindrop\LocaleBundle\Tests\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Session\Session;
use Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;

use Raindrop\LocaleBundle\Controller\LocaleController;
...
class LocaleControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $metaValidator = $this->getMockBuilder('Raindrop\LocaleBundle\Validator\MetaValidator')->disableOriginalConstructor()->getMock();
        if ($expectTrue) {
