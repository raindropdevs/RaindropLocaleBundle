...
namespace Raindrop\LocaleBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('raindrop_locale');
        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('router_guesser')
                    ...
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\RouterLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('browser_guesser')
                    ...
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\BrowserLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\CookieLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\SessionLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('sonata_guesser')
                ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\SonataLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')
                            ->defaultValue('Raindrop\LocaleBundle\LocaleGuesser\QueryLocaleGuesser')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('cookie')
                    ...
                    ->children()
                        ...
                        ->scalarNode('class')->defaultValue('Raindrop\LocaleBundle\Cookie\LocaleCookie')->end()
                        ->scalarNode('name')->defaultValue('raindrop_locale')->end()
                ...
                ->arrayNode('session')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('variable')->defaultValue('raindrop_locale')->end()
                     ->end()
                ->end()
                ->arrayNode('query')
                    ->addDefaultsIfNotSet()
