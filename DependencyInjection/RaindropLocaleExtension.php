 ...
 */
class RaindropLocaleExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('raindrop_locale.intl_extension_installed', $intlExtensionInstalled);
        $iso3166 = array();
        $iso639one = array();
        $iso639two = array();
        $localeScript = array();
        ...
        $container->setParameter('raindrop_locale.intl_extension_fallback.iso3166', $iso3166);
