...
To override the default template, create a template in your own src directory at the following location: `src/Raindrop/LocaleBundle/Resources/views/Switcher/switcher_links.html.twig`
